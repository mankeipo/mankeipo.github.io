      ...
      return(
        <div class="projects">
            ...
            <div class="cards">
                ...
                <Card name="Stray-Finder" words="&emsp;&emsp;A full-stack web application for locating and tracking stray animals using React, JavaScript, and Express.js, integrating Google Maps API for stray coordinates, a RESTful API, AWS S3 for image storage, and Nodemailer for subscriber notifications" type="Frontend Application" link="https://github.com/csci-499-fa24/Stray-Finder" img={stray_finder}></Card>
            </div>
